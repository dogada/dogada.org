...
- [wikiket.com — Buyer-focused marketplace (mix of Wikipedia and Amazon). No ads, honest reviews of FPV drones, smartbands and other electronics.](https://wikiket.com)
- [sifolk.com — Silicon Age Professionals (killer of LinkedIn).](https://sifolk.com) <abbr title="Work In Progress">WIP</abbr>
- [coect — decentralized media platform (blockchain and IPFS). It will fix Twitter sometime.](https://coect.dogada.org/) <abbr title="Work In Progress">WIP</abbr>
